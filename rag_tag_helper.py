...
# 步驟1: 讀取原始的 JSON 檔案
file_path = os.path.join(os.path.dirname(__file__), 'rag_knowledge_base', 'information', '醫學資訊管理師', 'all_questions.json')
...
for item in questions:
    ...
    try:
        ...
        # 步驟4: 加上延遲，避免超過速率限制
        # time.sleep(3) # 這裡設定了 3 秒的延遲，您可以根據需要調整
...
output_file_path = 'all_questions_with_keywords.json'
